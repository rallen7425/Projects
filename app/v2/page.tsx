      ...
      <div className="w-full max-w-[430px] h-full flex flex-col bg-white">
        ...
        <div className="flex-shrink-0 px-4 pt-3 pb-3" style={{ background: "#1c2b4a" }}>
          <div className="flex justify-between mb-1">
            <span className="text-[10px] text-white/40 tracking-widest uppercase">FRI, MAY 22</span>
            <span className="text-[10px] text-white/40 tracking-widest uppercase">NORTH ANDOVER, MA</span>
          </div>
          <div className="flex items-end justify-between">
            <div>
              <div className="text-[22px] font-semibold text-white tracking-tight leading-none">Distilled</div>
              <div className="text-[11px] text-white/40 mt-0.5">Good morning, Rick</div>
            </div>
            <span className="text-[10px] italic px-2 py-0.5 rounded bg-white/10 text-white/40">v2 prototype</span>
          </div>
        </div>
...
function NavTab({ label, active, children }: { label: string; active?: boolean; children: React.ReactNode }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-0.5 py-2 touch-manipulation">
      {children}
